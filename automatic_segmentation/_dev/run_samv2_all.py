...
cv.imwrite(os.path.join(os.path.dirname(__file__), "samv2_all_overlays.jpg"), mont, [cv.IMWRITE_JPEG_QUALITY, 72])
print(f"saved samv2_all_overlays.jpg ({mont.shape[1]}x{mont.shape[0]})")
